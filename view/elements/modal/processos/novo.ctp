                    ...
                    <div class="col-sm-6 b-r"><h3 class="m-t-none m-b">NOVO PROCESSO</h3>
                        ...
                        <div class="widget-box"> 
                            ...
                            <?php echo $this->Form->create('Processo', ['url' => ['action' => 'novo']]); 
                                 ...
                                 echo 'Data da publicação da portaria de instauração', $this->Form->date('data_bgo',array('label'=>'Data do BGO de abertura', 'class' => 'form-control', 'div' => 'form-group','dateFormat'=>'DMY', 'minYear' => date('Y') - 90, 'maxYear' => date('Y') + 16));
                                 //echo $this->Form->input('num_processo',array('label'=>'Número do processo', 'upper' => 'true', 'class' => 'form-control', 'div' => 'form-group'));
                                 echo $this->Form->input('num_portaria',array('label'=>'Número da portaria', 'class' => 'form-control', 'div' => 'form-group'));
                                 ...
                                 //echo $this->Form->input('criador_processo_id', array('value' => $usuario_atual['cpf'], 'type'=> 'hidden')); NAO PRECISA MAIS POIS O INSTAURADOR É O ÚNICO QUE CRiA UM NOVO PROCESSO
