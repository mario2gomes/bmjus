<!-- Modal -->
<div class="modal fade" id="novo_escrivao" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-6 b-r"><h3 class="m-t-none m-b">Designar escrivão</h3>
...
-->
                        <?php
                        echo $this->Form->create('Usuario', ['url' => ['action' => 'novo_escrivao']]);
