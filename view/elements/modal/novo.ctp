                    ...
                    <div class="col-sm-6 b-r"><h3 class="m-t-none m-b">NOVO PROCESSO</h3>
                        ...
                        <div class="widget-box"> 
                            ...
                            <?php echo $this->Form->create('Processo', ['url' => ['action' => 'novo']]); 
                                 ...
                                 echo $this->Form->input('encarregado',array('class' => 'form-control', 'div' => 'form-group','label'=>'Encarregado (matricula)', 'placeholder' => "exibir as opções dentro dos militares da obm e pela fila"));
                                 echo $this->Form->input('investigado',array('label'=>'Investigado (se houver)(matrícula)', 'class' => 'form-control', 'div' => 'form-group', 'placeholder' => "usar autocompletar com os militares da unidade"));
