...
<?php
	if (is_writable(TMP)):
		...
		echo '<span class=\"notice\">';
			echo __d('cake_dev', 'Seu diretório tmp NÃƒO está habilitado para escrita.');
		echo '</span>';
	endif;
?>
</p>
...
<?php
	...
	if (!empty(\$settings)):
		...
		echo '<span class=\"notice\">';
				echo __d('cake_dev', 'Seu cache NÃƒO está funcionando. Por favor, verifique suas configurações em APP/Config/core.php');
		echo '</span>';
	endif;
?>
</p>
...
<?php
	...
	if (file_exists(APP . 'Config' . DS . 'database.php')):
		...
		echo '<span class=\"notice\">';
			echo __d('cake_dev', 'Seu arquivo de configuração do banco de dados NÃƒO está presente.');
			echo '<br/>';
...
<?php
	if (\$connected && \$connected->isConnected()):
		...
		echo '<span class=\"notice\">';
			echo __d('cake_dev', 'Cake NÃƒO está apto para conectar no banco de dados.');
		echo '</span>';
	endif;
?>
</p>
