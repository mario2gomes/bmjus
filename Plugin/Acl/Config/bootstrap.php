 ...
 */
Configure :: write('acl.aro.role.foreign_key', 'grupo_bmjus');
 ...
 * (can be left empty if your primary key's name follows CakePHP conventions)('id')
 */
Configure :: write('acl.aro.user.primary_key', 'mat_usuario');

/*
 * The name of the database field that can be used to display the role name
 */
Configure :: write('acl.aro.role.display_field', 'dsc_grupo');
 ...
 */
Configure :: write('acl.user.display_name', "Usuario.mat_usuario");
...
/*
 * Indicaчуo que somente щ para usar Group Rules
 */
Configure :: write('acl.only_group_rules', true);
