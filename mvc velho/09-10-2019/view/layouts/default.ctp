...
<head>
    ...
    <title>     
        ...
        //Custom Scripts
        echo $this->Html->script(array('inspinia', 'plugins/pace/pace.min', 'plugins/metisMenu/jquery.metisMenu', 'plugins/slimscroll/jquery.slimscroll.min', 'plugins/toastr/toastr.min', 'plugins/bootbox/bootbox.min', 'gatilhos', 'tabelaPesquisa'));
        //Inclui o chat
