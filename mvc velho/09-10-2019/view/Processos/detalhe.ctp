                                    ...
                                    <div class="feed-activity-list">
                                        ...
                                        <div class="feed-element">
                                            ...
                                            <div class="media-body ">
                                                ...
                                                Arquivo: <?php 
                                                $documento_fisico = '/uploads'.DS.'processos'.DS.$processo['Tipo_processo']['descricao'].DS.str_replace(' ','_',str_replace('/','_',$processo['Processo']['num_processo'])).DS.$documento['Documento']['nome_arquivo'];
                                                $doc = $documento['Documento']['nome_arquivo'];
                                                echo $this-> Html-> link($documento_fisico, '/uploads'.DS.'processos'.DS.$processo['Tipo_processo']['descricao'].DS.str_replace(' ','_',str_replace('/','_',$processo['Processo']['num_processo'])).DS.$documento['Documento']['nome_arquivo']);
                                                ?> <br>
