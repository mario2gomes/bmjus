                        ...
                        <h3 class="m-t-none m-b"><?php echo 'Reabrir ', $processo['Tipo_processo']['descricao'],' ', $processo['Processo']['num_processo']; ?></h3>
                            <div class="widget-box"> 
                                Qual a data de reabertura do processo?
                                   <?php 
                                   pr($processo['Suspensao']);
                                   $suspensao = end($processo['Suspensao']);
                                    ...
                                    echo $this->Form->date('data_termino',array('label'=>'Data de reabertura: ', 'dateFormat'=>'DMY', 'minYear' => date('Y') - 90, 'maxYear' => date('Y') + 10));
