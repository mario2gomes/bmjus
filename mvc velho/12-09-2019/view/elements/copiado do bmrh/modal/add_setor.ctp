<div id="setor" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
        <div class="obms form">    
            <div class="widget-box">                    
                        ...
                        <?echo $this->Form->input('obm_pai', array('value'=>$obm['Obm']['id'], 'type'=>'hidden'));?>                            
                        <hr>
