...
class ProcessosController extends AppController {
    ...
    function novo() {
        ...
        if ($this->request->is('post')) {
            ...
            $this -> request -> data ['Processo']['obm'] = $this-> ViewMilitar->getPessoa($this->request->data['Processo']['instaurador'])['obm'];
...
/*    function enviarDocumento(){
    ...
    public function resumo($id_processo=null){
        $processo = $this->Processo->findById($id_processo);
        ...
        if ($this->request->is('get')){
            $this->set('encarregado', $this-> ViewMilitar-> getPessoa($processo['Processo']['encarregado']));
            $this->set('instaurador', $this-> ViewMilitar-> getPessoa($processo['Processo']['instaurador']));
            $this->set('escrivao', $this-> ViewMilitar-> getPessoa($processo['Processo']['escrivao']));
            $this->set('investigado', $this-> ViewMilitar-> getPessoa($processo['Processo']['investigado']));
            $this->set('criador', $this-> ViewMilitar-> getPessoa($processo['Processo']['criador_processo_id']));
        }
