    ...
    <div class="col-sm-4">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <?php } 
                            if( $grupos == 2 && $processo['Processo']['estados_id'] == 4){ ?>
                    <div class="text-center">
                        <button type="button" class="btn btn-danger btn-block" data-toggle="modal" data-target="#parecer">Emitir parecer</button>
                    </div>
                <?php } ?>
