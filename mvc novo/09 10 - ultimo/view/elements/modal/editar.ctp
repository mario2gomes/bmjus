                ...
                <div class="row">
                    <div class="col-sm-6 b-r"><h3 class="m-t-none m-b">NOVO PROCESSO</h3>
                        ...
                        <div class="widget-box"> 
                            ...
                            <?php echo $this->Form->end('Editar', array('class'=>"btn btn-sm btn-primary pull-right m-t-n-xs"));?>
                            <!-- <button class="btn btn-sm btn-primary pull-right m-t-n-xs" type="submit"><strong>Editar</strong></
                                button> -->
                        </div>
                    </div>
                </div>
