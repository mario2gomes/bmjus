                    ...
                    <div class="col-sm-6 b-r"><h3 class="m-t-none m-b">NOVO PROCESSO</h3>
                        ...
                        <div class="widget-box"> 
                            ...
                            <?php echo $this->Form->create('Processo', ['url' => ['action' => 'novo']]); 
                                 ...
                                 echo $this->Form->input('num_processo',array('label'=>'Número do processo', 'upper' => 'true', 'class' => 'form-control', 'div' => 'form-group', 'placeholder' => "Número do processo"));
                                 echo $this->Form->input('num_portaria',array('label'=>'Número da portaria', 'class' => 'form-control', 'div' => 'form-group', 'placeholder' => "Número da portaria"));
                                 ...
                                 echo $this->Form->input('escrivao',array('label'=>'Escrivao (se houver)', 'class' => 'form-control', 'div' => 'form-group', 'placeholder' => "escrivão", 'label'=>'Escrivão'));
                                 echo $this->Form->input('descricao',array('type'=>'textarea', 'class' => 'form-control', 'div' => 'form-group', 'placeholder' => "descrição", 'label'=>'Observação'));
