...
<head>
    ...
    <title>     
        ...
        echo $this->Html->script(array('plugins/dataTables/jquery.dataTables', 'plugins/dataTables/dataTables.bootstrap','plugins/dataTables/dataTables.responsive','plugins/dataTables/dataTables.tableTools.min'));
