                ...
                <div class="row">
                    <div class="col-sm-6 b-r"><h3 class="m-t-none m-b">ENVIAR DOCUMENTO</h3>
                        ...
                        <div class="upload-frm">
                            ...
                            <?php
                            $uploadData = '';
                            echo $this->Form->create('Documento', array('type' => 'file','url'=>array('controller'=>'processos','action'=>'enviar_documento')));
                            //echo $this->Form->create($uploadData, ['type' => 'file']); 
                            echo $this->Form->input('tipo_documento_id',array('class' => 'form-control', 'div' => 'form-group', 'placeholder' => "Tipo de documento", 'label'=>'Tipo de documento: ','options' => $tipos_documento, 'empty' => '--Selecione--') );
                            ...
                            */
                            ...
                            echo $this->Form->button(__('Enviar arquivo'), ['type'=>'submit', 'class' => 'btn btn-sm btn-primary pull-right m-t-n-xs']);
                            echo $this->Form->end();?>
