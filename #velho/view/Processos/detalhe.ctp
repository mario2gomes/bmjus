                                    ...
                                    <div class="feed-activity-list">
                                        ...
                                        <div class="feed-element">
                                            <div href="#" class="pull-left">
                                                <?php echo $this->Html->link('Visualizar', array('controller' => 'processos', 'action' => 'abrir_documento', $processo['Tipo_processo']['descricao'], str_replace('/','_',$processo['Processo']['num_processo']) , $documento['Documento']['nome_arquivo']),array('type'=>'button','class'=>'btn btn-primary')); ?>
                                            </div>
