                ...
                <div class="row">
                    <div class="col-sm-6 b-r"><h3 class="m-t-none m-b">ENVIAR DOCUMENTO</h3>
                        ...
                        <div class="upload-frm form-group">
                            ...
                            <?php
                            $uploadData = '';
                            echo $this->Form->create('Documento', array('type' => 'file','url'=>array('controller'=>'processos','action'=>'enviarDocumento')));
                            ...
                            */
                            ...
                            echo $this->Form->button(__('Enviar arquivo'), ['type'=>'submit', 'class' => 'btn btn-sm btn-primary ']);
                            echo $this->Form->end();?>
