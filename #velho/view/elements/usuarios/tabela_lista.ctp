    ...
    <tr>
        ...
        <td class="client-avatar">
            <a><?php 
                ...
                echo 'Por aqui a foto do sistema com o código abaixo';
                while ($row = oci_fetch_array($stmt, OCI_ASSOC+OCI_RETURN_LOBS)) {
                    if($row['BLB_FOTO'] != ""){
                        ?><img src="data:image/jpeg;base64, echo base64_encode($row['BLB_FOTO']); ?php>" width="70" height="100" border="0" /> <? 
                    } else{ 
                        ?><img src="sem_foto.png" width="70" height="100" border="0" /> <? 
                    }//end if 
                }?>
        ...
        <td>
            <?php
                ...
                if(strcmp($situacao,'concluso') == 0){
                    ...
                    //ordena o array de acordo com a função cmp
                    usort($ultimos_processos, 'cmp');
                    //pega o último processo do array ordenado pela data de término
