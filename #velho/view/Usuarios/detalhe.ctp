                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <div class="input-group">
                                <input type="text" placeholder="Buscar militar" class="input form-control">
                                <span class="input-group-btn">
                                        <button type="button" class="btn btn btn-primary"> <i class="fa fa-search"></i> Busca</button>
                                </span>
                            </div>
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>                            
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <?php
                                                        echo $this->Html->image('a3.jpg', array('alt' => 'CakePHP'));
                                                    ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php
                                                        echo $this->Html->image('a4.jpg', array('alt' => 'CakePHP'));
                                                    ?>
                                ...
                                <div id="contact-1" class="tab-pane active">
                                    <div class="row m-b-lg">
                                        <div class="col-lg-4 text-center">
                                            ...
                                            <div class="m-b-sm">
<?php
    echo $this->Html->image('a2.jpg', array('alt' => 'CakePHP', 'class' =>'img-circle'));//, 'style' => 'width: 62px'));
?>
                                            </div>
                                        </div>
                                        <div class="col-lg-8">
                                ...
                                <div id="contact-2" class="tab-pane">
                                    <div class="row m-b-lg">
                                        <div class="col-lg-4 text-center">
                                            <h2>Edan Randall</h2>
<?php
    echo $this->Html->image('a3.jpg', array('alt' => 'CakePHP', 'class' =>'img-circle'));//, 'style' => 'width: 62px'));
?>
                                ...
                                <div id="contact-3" class="tab-pane">
                                    <div class="row m-b-lg">
                                        <div class="col-lg-4 text-center">
                                            <h2>Jasper Carson</h2>
<?php
    echo $this->Html->image('a4.jpg', array('alt' => 'CakePHP', 'class' =>'img-circle'));//, 'style' => 'width: 62px'));
?>
                                        </div>
                                        <div class="col-lg-8">
                                            <strong>
